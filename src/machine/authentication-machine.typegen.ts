...
"xstate.init": { type: "xstate.init" };
        ...
        missingImplementations: {
          actions: "Report to API that normal user logged in" | "Say hello to normal user";
          delays: never;
...
"User is admin": "done.invoke.Authentication.Checking user permissions level:invocation[0]";
        ...
        matchesStates: "Admin" | "Cancelled" | "Checking user permissions level" | "No Permission" | "Normal" | "Time out";
        tags: never;
      }
